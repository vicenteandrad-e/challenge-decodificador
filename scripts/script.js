...
const mensagem = document.querySelector("#principal__mensagem__textarea");

// Mostrando e ocultando elementos dentro do HTML
document.getElementById("principal__mensagem").style.display = 'none';
document.getElementById("principal__sinalizacao").style.display = 'initial';
...
function trocarElementos() {
    document.getElementById("principal__mensagem").style.display = 'inherit';
    document.getElementById("principal__sinalizacao").style.display = 'none'; 
}

// Função para copiar
async function copiarTexto() {
    const textoArea = document.querySelector("#principal__mensagem__textarea");
    try {
...
function mudarTextoBotao() {
    document.querySelector(".principal__mensagem__botao").innerHTML = "Texto Copiado!";
}

function resetarTextoBotao() {
    document.querySelector(".principal__mensagem__botao").innerHTML = "Copiar";
}
